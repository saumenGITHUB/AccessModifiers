...
namespace CSharpeAccessModifiers
{
    class CSharpeAccessModifiers : StoreOfFunctions
    {
        ...
        private void AccessingMethods()
        {
            ...
            ProtecedMethod();  // Access Modifier is PROTECT INTERNAL : We have implemeted <StoreOfFunctions> and it is accessible here and it is also accessbile in <StoreOfFunctionsToAccess> assembly to all methods even though they have NOT implemented <StoreOfFunctions>
